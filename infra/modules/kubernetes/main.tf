...
# Managed Node Group (system pods only — Karpenter handles application workloads)
...
# OIDC Provider for IRSA (Karpenter, etc.)
...
resource "aws_security_group" "karpenter_nodes" {
  ...
  tags = {
    Name                       = "${local.cluster_name}-karpenter-nodes"
